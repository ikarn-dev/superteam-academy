/**
 * Dashboard Studio — embedded Sanity Studio for course content management.
 *
 * Same Sanity Studio as the admin version, but accessible to authenticated users
 ...
 * Users can create/edit content, but publishing may require admin approval
